...
import static Jframe.HomePage_Member.usernamee;
...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Not a registered member yet?");

        jButton1.setFont(new java.awt.Font("Book Antiqua", 1, 12)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 51, 51));
        jButton1.setText("Register as a member");
        ...
        if (!username.trim().equals("") && !password.trim().equals("")){
            ...
            try {
                ...
                if(rs.next()){ //If the user exist
                    ...
                    //Call homepage form 
                    HomePage_Member dash_f = new HomePage_Member();
                    dash_f.setVisible(true);
                    usernamee.setText(rs.getString(6));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        RegisterPage signinp = new RegisterPage();
